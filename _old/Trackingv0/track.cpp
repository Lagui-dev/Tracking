...
//            this, SLOT(updateButtons(int)));
    connect(ui->tableView->selectionModel(), SIGNAL(currentRowChanged() (QModelIndex,QModelIndex)),
            this,SLOT(model2text(QModelIndex, QModelIndex)));
...
void track::on_btnAdd_clicked()
{
    ...
    newRecord.setValue(4,"2014-01-01");
    newRecord.setValue(5,1);
    newRecord.setValue(6,"2014-01-01");
...
void track::model2text(QModelIndex current, QModelIndex previous)
{
    //ui->txtIssue->insertPlainText(this->model->data(row) );
    qDebug() << "model2text";
}
